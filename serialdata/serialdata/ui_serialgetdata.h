...
"background-color: rgb(0, 0, 0);"));
        ...
        groupBox->setGeometry(QRect(30, 20, 221, 301));
        QFont font1;
...
"border-color: rgb(255, 0, 0);"));
        ...
        groupBox_2->setGeometry(QRect(30, 350, 721, 181));
        QFont font4;
...
"boder:none;"));
        ...
        groupBox_3->setGeometry(QRect(350, 20, 431, 301));
        QFont font6;
        ...
        layoutWidget->setGeometry(QRect(20, 30, 388, 251));
        ...
        lcdTemp = new QLCDNumber(layoutWidget);
        lcdTemp->setObjectName(QStringLiteral("lcdTemp"));
        lcdTemp->setStyleSheet(QLatin1String("color: rgb(255, 0, 0);\n"
"background-color: rgb(0, 0, 0);\n"
"border-color: rgb(255, 0, 0);"));
        lcdTemp->setDigitCount(5);
        lcdTemp->setMode(QLCDNumber::Dec);

        horizontalLayout_7->addWidget(lcdTemp);
...
"border-color: rgb(255, 0, 0);"));
        ...
        horizontalLayout_10->addWidget(eConnectBtn);
...
"border-color: rgb(255, 0, 0);"));
        ...
        horizontalLayout_10->addWidget(eDisconnectBtn);
    ...
    void retranslateUi(QMainWindow *SerialGetData)
    {
        ...
        groupBox_3->setTitle(QApplication::translate("SerialGetData", "\346\270\251\346\271\277\345\272\246\357\274\232", Q_NULLPTR));
        label_6->setText(QApplication::translate("SerialGetData", "\346\270\251\345\272\246\357\274\232", Q_NULLPTR));
        label_7->setText(QApplication::translate("SerialGetData", "\346\271\277\345\272\246\357\274\232", Q_NULLPTR));
